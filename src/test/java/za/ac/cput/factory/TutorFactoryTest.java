...
class TutorFactoryTest {
    ...
    void buildTutor() {
        ...
        ,3,profilePicture,idDocument,sarsDocument, TutorApprovalStatus.APPROVED);
        assertNotNull(tutor);
    ...
    void buildTutorPending() {
        ...
        ,4,profilePicture,idDocument,sarsDocument, TutorApprovalStatus.PENDING);
        assertNotNull(tutor);
    ...
    void buildTutorDecline() {
        ...
        ,3,profilePicture,idDocument,sarsDocument, TutorApprovalStatus.DECLINED);
        assertNotNull(tutor);
