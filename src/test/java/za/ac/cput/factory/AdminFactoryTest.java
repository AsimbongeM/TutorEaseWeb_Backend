...
public class AdminFactoryTest {
    ...
    public void buildAdmin_NullPassword() {
        Admin admin = AdminFactory.buildAdmin(null, "John", "Doe", "john.doe@example.com", "1234567890");
    ...
    public void buildAdmin_EmptyPassword() {
        Admin admin = AdminFactory.buildAdmin( "", "John", "Doe", "john.doe@example.com", "1234567890");
    ...
    public void buildAdmin_InvalidEmail() {
        Admin admin = AdminFactory.buildAdmin("password", "John", "Doe", "invalid-email", "1234567890");
    ...
    public void buildAdmin_NullFirstName() {
        Admin admin = AdminFactory.buildAdmin( "password", null, "Doe", "john.doe@example.com", "1234567890");
    ...
    public void buildAdmin_EmptyFirstName() {
        Admin admin = AdminFactory.buildAdmin( "password", "", "Doe", "john.doe@example.com", "1234567890");
    ...
    public void buildAdmin_NullLastName() {
        Admin admin = AdminFactory.buildAdmin("password", "John", null, "john.doe@example.com", "1234567890");
    ...
    public void buildAdmin_EmptyLastName() {
        Admin admin = AdminFactory.buildAdmin( "password", "John", "", "john.doe@example.com", "1234567890");
    ...
    public void buildAdmin_NullCellphoneNumber() {
        Admin admin = AdminFactory.buildAdmin( "password", "John", "Doe", "john.doe@example.com", null);
    ...
    public void buildAdmin_EmptyCellphoneNumber() {
        Admin admin = AdminFactory.buildAdmin( "password", "John", "Doe", "john.doe@example.com", "");
