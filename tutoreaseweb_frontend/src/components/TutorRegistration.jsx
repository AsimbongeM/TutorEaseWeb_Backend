...
const TutorRegistration = () => {
    ...
    return (
        <div style={styles.registrationContent}>
            ...
            <h2 style={styles.formTitle}>Tutor Registration</h2>
            <form style={styles.registrationForm}>
                ...
                <div style={styles.formGroup}>
                    <label htmlFor="id-upload" style={styles.label}>ID Document:</label>
                    <input type="file" id="id-upload" name="id-upload" required style={styles.fileInput} />
                </div>
                <div style={styles.formGroup}>
                    <label htmlFor="sars-document" style={styles.label}>SARS Reg:</label>
                    <input type="file" id="sars-document" name="sars-document" required style={styles.fileInput} />
                </div>
