            ...
            getStudentById(email)
                .then((response) => {
                    if (response.data) {
                        ...
                        const student = { firstName, lastName, email, password, age, cellNumber, skillLevel };
        ...
        <div className="container my-5" style={{ maxWidth: '500px', background: '#e6f2ff' }}>
            ...
            <form className="p-4 rounded shadow-sm" style={{ background: 'linear-gradient(#57adeb, rgb(182, 208, 226))' }} onSubmit={handleSignUp}>
                ...
                <div className="mb-3">
                    ...
                    <select id="skillLevel" name="skillLevel" className="form-select" value={skillLevel} onChange={(e) => setSkillLevel(e.target.value)}>
